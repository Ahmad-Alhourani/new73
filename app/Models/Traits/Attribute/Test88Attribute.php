...
trait Test88Attribute
{
    ...
    /**
     * @return string  test88
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.test88.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.test88.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" test88="group" aria-label="Test88 Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
